...
def drawStartup(device, width, height):
    ...
    with canvas(device) as draw:
        ...
        nameSize = draw.textlength("UK Train Departure Display", fontBold)
        #poweredSize = draw.textsize("Powered by", fontBold)
        poweredSize = draw.textlength("Powered by", fontBold)
        #NRESize = draw.textsize("National Rail Enquiries", fontBold)
        NRESize = draw.textlength("National Rail Enquiries", fontBold)
...
def drawBlankSignage(device, width, height, departureStation):
    ...
    with canvas(device) as draw:
        ...
        welcomeSize = draw.textlength("Welcome to", fontBold)

    with canvas(device) as draw:
        #stationSize = draw.textsize(departureStation, fontBold)
        stationSize = draw.textlength(departureStation, fontBold)
